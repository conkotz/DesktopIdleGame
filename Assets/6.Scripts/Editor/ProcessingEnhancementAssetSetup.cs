...
public static class ProcessingEnhancementAssetSetup
{
    ...
    private static readonly EnhancementSpec[] Specs =
    {
        new(
            ...
            "cooking_salt",
            "Salt",
            "Cooking enhancement. Reduces the time to cook by 1 second per action while loaded in the range. Consumes 1 per attempt.",
            50,
        ...
        new(
            ...
            "cooking_spice",
            "Spice",
            "Cooking enhancement. Reduces the time to cook by 2 seconds per action while loaded in the range. Consumes 1 per attempt.",
            150,
    ...
    private static readonly SmeltingEnhancementSpec[] SmeltingSpecs =
    {
        new(
            ...
            "smelting_coal",
            "Coal",
            "Smelting enhancement. Reduces the time to smelt by 2 seconds per action while loaded in the furnace. Consumes 1 per bar.",
            100,
