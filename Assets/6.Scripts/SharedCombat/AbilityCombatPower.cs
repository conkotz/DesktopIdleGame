...
public static class AbilityCombatPower
{
    ...
    public const float SoulforgedWarriorWarcryIntervalSeconds = 15f;
    ...
    public const float SoulforgedWarriorWarcryAllyRange = 8f;
    public const float SoulforgedWarriorTauntRange = 8f;
    public const float SoulforgedWarriorFuriousSlamRange = 4f;
