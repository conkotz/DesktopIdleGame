    ...
    IPointerClickHandler
{
    ...
    private static string BuildActiveEnhancementLineForAbility(AbilityDefinition def, SkillsManager skillsManager)
    {
        ...
        if (string.Equals(def.abilityId, AbilityCombatPower.LightningRodAbilityId, System.StringComparison.OrdinalIgnoreCase))
        {
            int selected = skillsManager.GetSkillChoiceSelection(
                SkillType.Ranged, AbilityCombatPower.LightningRodEnhancementParentSpineNodeId, -1);
            return BuildActiveEnhancementLine(def, selected);
        }

        if (string.Equals(def.abilityId, AbilityCombatPower.PenetratingShotAbilityId, System.StringComparison.OrdinalIgnoreCase))
        {
            int selected = skillsManager.GetSkillChoiceSelection(
                SkillType.Ranged, AbilityCombatPower.PenetratingShotEnhancementParentSpineNodeId, -1);
            return BuildActiveEnhancementLine(def, selected);
        }

        if (string.Equals(def.abilityId, AbilityCombatPower.HuntersSwiftnessAbilityId, System.StringComparison.OrdinalIgnoreCase))
        {
            int selected = skillsManager.GetSkillChoiceSelection(
                SkillType.Ranged, AbilityCombatPower.HuntersSwiftnessEnhancementParentSpineNodeId, -1);
            return BuildActiveEnhancementLine(def, selected);
        }

        if (string.Equals(def.abilityId, AbilityCombatPower.TornadoAbilityId, System.StringComparison.OrdinalIgnoreCase))
        {
            int selected = skillsManager.GetSkillChoiceSelection(
                SkillType.Ranged, AbilityCombatPower.TornadoEnhancementParentSpineNodeId, -1);
            return BuildActiveEnhancementLine(def, selected);
        }
